...
abstract class ProductDummyDataSource {
  Future<List<Product>> getProducts();
}

@LazySingleton(as: ProductDummyDataSource)
class ProductDummyDataSourceImpl implements ProductDummyDataSource {
  static const Map<String, dynamic> dummyProducts = {
    'products': [
      {
        'id': 1,
        'title': 'iPhone 9',
  ...
  Future<List<Product>> getProducts() {
    return Future.delayed(
      Duration.zero,
      () => ProductModel.fromJsonList(dummyProducts['products']),
    );
  }
}
